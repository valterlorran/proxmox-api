export declare namespace Proxmox {
    /**
     * Description.
     * @maxLength 4096
     */
    type String0_4096 = string;
    /**
     ...
     */
    type pvereplicationjobid = string;
    /**
     ...
     * @maxLength 4096
     */
    type pveconfigidlist = string;
    /**
     * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
     * @maxLength 40
     */
    type String0_40 = string;
    /**
     * The name of the cluster.
     * @format pve-node
     * @maxLength 15
     */
    type pvenode_1 = string;
    /**
     ...
     * @type integer
     */
    type integer_Min0 = number;
    /**
     * Certificate SHA 256 fingerprint.
     * @pattern ([A-Fa-f0-9]{2}:){31}[A-Fa-f0-9]{2}
     */
    type Tfingerprint = string;
    /**
     ...
     * @maxLength 20
     */
    type pveiface = string;
    /**
     * Log level for firewall rule.
     */
    type Tlog = 'emerg' | 'alert' | 'crit' | 'err' | 'warning' | 'notice' | 'info' | 'debug' | 'nolog';
    /**
     * IP protocol. You can use protocol names ('tcp'/'udp') or simple numbers, as defined in '/etc/protocols'.
     * @format pve-fw-protocol-spec
     */
    type pvefwprotocolspec = string;
    /**
     * Restrict TCP/UDP source port. You can use service names or simple numbers (0-65535), as defined in '/etc/services'. Port ranges can be specified with '\d+:\d+', for example '80:85', and you can use comma separated list to match several ports or ranges.
     * @format pve-fw-sport-spec
     */
    type pvefwsportspec = string;
    /**
     * Rule type.
     */
    type Ttype_1 = 'in' | 'out' | 'group';
    /**
     * A list of settings you want to delete.
     * @format pve-configid-list
     */
    type pveconfigidlist_1 = string;
    /**
     * IP set name.
     * @pattern [A-Za-z][A-Za-z0-9\-\_]+
     * @minLength 2
     ...
     */
    type Tlog_ratelimit = string;
    /**
     * Input policy.
     */
    type Tpolicy_in = 'ACCEPT' | 'REJECT' | 'DROP';
    /**
     * Only list references of specified type.
     */
    type Ttype_2 = 'alias' | 'ipset';
    /**
     * Compress dump file.
     */
    type Tcompress = '0' | '1' | 'gzip' | 'lzo' | 'zstd';
    /**
     * Day of week selection.
     * @format pve-day-of-week-list
     */
    type pvedayofweeklist = string;
    /**
     * Exclude specified guest systems (assumes --all)
     * @format pve-vmid-list
     */
    type pvevmidlist = string;
    /**
     * Exclude certain files/directories (shell globs).
     * @format string-alist
     */
    type stringalist = string;
    /**
     ...
     * @type integer
     */
    type integer0_8 = number;
    /**
     * Specify when to send an email
     */
    type Tmailnotification = 'always' | 'failure';
    /**
     ...
     * Backup mode.
     */
    type Tmode = 'snapshot' | 'suspend' | 'stop';
    /**
     * Unused, will be removed in a future release.
     * @minimum 500
     * @type integer
     */
    type integer_Min500 = number;
    /**
     * Job Start time.
     * @pattern \d{1,2}:\d{1,2}
     */
    type Tstarttime = string;
    /**
     * Store resulting file to this storage.
     * @format pve-storage-id
     */
    type pvestorageid = string;
    /**
     ...
     * @pattern ^https?://.*
     */
    type Tdirectory = string;
    type Tscope = 'all' | 'versions';
    /**
     ...
     */
    type pvesdnvnetid = string;
    /**
     * Only list sdn zones of specific type
     */
    type Ttype_7 = 'evpn' | 'faucet' | 'qinq' | 'simple' | 'vlan' | 'vxlan';
    /**
     * peers address list.
     * @format ip-list
     */
     ...
     * @format pve-configid
     */
    type pveconfigid_1 = 'evpn' | 'faucet' | 'qinq' | 'simple' | 'vlan' | 'vxlan';
    type Tvlanprotocol = '802.1q' | '802.1ad';
    /**
     * The SDN zone object identifier.
     * @format pve-sdn-zone-id
     */
    type pvesdnzoneid = string;
    /**
     * Only list sdn controllers of specific type
     */
    type Ttype_8 = 'evpn' | 'faucet';
    /**
     * The SDN controller object identifier.
     * @format pve-sdn-controller-id
     */
    type pvesdncontrollerid = string;
    /**
     * Plugin type.
     * @format pve-configid
     */
    type pveconfigid_2 = 'evpn' | 'faucet';
    type Ttype_9 = 'vm' | 'storage' | 'node' | 'sdn';
    /**
     ...
     */
    type Tbwlimit = string;
    /**
     * Select the default Console viewer. You can either use the builtin java applet (VNC; deprecated and maps to html5), an external virt-viewer comtatible application (SPICE), an HTML5 based vnc viewer (noVNC), or an HTML5 based console client (xtermjs). If the selected viewer is not available (e.g. SPICE not activated for the VM), the fallback is noVNC.
     */
    type Tconsole = 'applet' | 'vv' | 'html5' | 'xtermjs';
    /**
     * Specify email address to send notification from (default is root@$hostname)
     * @format email-opt
     */
    type emailopt = string;
    /**
     ...
     */
    type Tfencing = 'watchdog' | 'hardware' | 'both';
    /**
     ...
     * @pattern http://.*
     */
    type Thttp_proxy = string;
    /**
     * Default keybord layout for vnc server.
     */
    type Tkeyboard = 'de' | 'de-ch' | 'da' | 'en-gb' | 'en-us' | 'es' | 'fi' | 'fr' | 'fr-be' | 'fr-ca' | 'fr-ch' | 'hu' | 'is' | 'it' | 'ja' | 'lt' | 'mk' | 'nl' | 'no' | 'pl' | 'pt' | 'pt-br' | 'sv' | 'sl' | 'tr';
    /**
     * Default GUI language.
     */
    type Tlanguage = 'ca' | 'da' | 'de' | 'en' | 'es' | 'eu' | 'fa' | 'fr' | 'he' | 'it' | 'ja' | 'nb' | 'nn' | 'pl' | 'pt_BR' | 'ru' | 'sl' | 'sv' | 'tr' | 'zh_CN' | 'zh_TW';
    /**
     ...
     */
    type pveqmbootdisk = string;
    /**
     * This is an alias for option -ide2
     * @format pve-qm-ide
     */
    type pveqmide = string;
    /**
     * cloud-init: Specify custom files to replace the automatically generated ones at start.
     * @format pve-qm-cicustom
     */
    type pveqmcicustom = string;
    /**
     * Specifies the cloud-init configuration format. The default depends on the configured operating system type (`ostype`. We use the `nocloud` format for Linux, and `configdrive2` for windows.
     */
    type Tcitype = 'configdrive2' | 'nocloud';
    /**
     * Emulated CPU type.
     * @format pve-vm-cpu-conf
     */
    type pvevmcpuconf = string;
    /**
     * Limit of CPU usage.
     ...
     */
    type Tefidisk0 = string;
    /**
     * Script that will be executed during various steps in the vms lifetime.
     * @format pve-volume-id
     */
    type pvevolumeid = string;
    /**
     ...
     */
    type pveqmhostpci = string;
    /**
     * Selectively enable hotplug features. This is a comma separated list of hotplug features: 'network', 'disk', 'cpu', 'memory' and 'usb'. Use '0' to disable hotplug completely. Value '1' is an alias for the default 'network,disk,usb'.
     * @format pve-hotplug-features
     */
    type pvehotplugfeatures = string;
    /**
     * Enable/disable hugepages memory.
     */
    type Thugepages = 'any' | '2' | '1024';
    /**
     ...
     */
    type Tivshmem = string;
    /**
     * Lock/unlock the VM.
     */
    type Tlock = 'backup' | 'clone' | 'create' | 'migrate' | 'rollback' | 'snapshot' | 'snapshot-delete' | 'suspending' | 'suspended';
    /**
     * Specifies the Qemu machine type.
     * @pattern (pc|pc(-i440fx)?-\d+(\.\d+)+(\+pve\d+)?(\.pxe)?|q35|pc-q35-\d+(\.\d+)+(\+pve\d+)?(\.pxe)?|virt(?:-\d+(\.\d+)+)?(\+pve\d+)?)
     * @maxLength 40
     */
    type Tmachine = string;
    /**
     * Amount of RAM for the VM in MB. This is the maximum available memory when you use the balloon device.
     * @minimum 16
     * @type integer
     */
    type integer_Min16 = number;
    /**
     * Set maximum tolerated downtime (in seconds) for migrations.
     * @minimum 0
     * @type number
     */
    type Tmigrate_downtime = number;
    /**
     ...
     *
     */
    type Tostype = 'other' | 'wxp' | 'w2k' | 'w2k3' | 'w2k8' | 'wvista' | 'win7' | 'win8' | 'win10' | 'l24' | 'l26' | 'solaris';
    /**
     ...
     */
    type Tparallel = string;
    /**
     * Add the VM to the specified pool.
     * @format pve-poolid
     */
    type pvepoolid = string;
    /**
     ...
     */
    type Tscsihw = 'lsi' | 'lsi53c810' | 'virtio-scsi-pci' | 'virtio-scsi-single' | 'megasas' | 'pvscsi';
    /**
     ...
     * @type integer
     */
    type integer0_50000 = number;
    /**
     * Specify SMBIOS type 1 fields.
     * @format pve-qm-smbios1
     * @maxLength 512
     */
    type pveqmsmbios1 = string;
    /**
     ...
     */
    type Tspice_enhancements = string;
    /**
     ...
     */
    type pveqmwatchdog = string;
    /**
     * The QGA command.
     */
    type Tcommand = 'fsfreeze-freeze' | 'fsfreeze-status' | 'fsfreeze-thaw' | 'fstrim' | 'get-fsinfo' | 'get-host-name' | 'get-memory-block-info' | 'get-memory-blocks' | 'get-osinfo' | 'get-time' | 'get-timezone' | 'get-users' | 'get-vcpus' | 'info' | 'network-get-interfaces' | 'ping' | 'shutdown' | 'suspend-disk' | 'suspend-hybrid' | 'suspend-ram';
    /**
     * The new password.
     * @minLength 5
     * @maxLength 1024
     */
    type String5_1024 = string;
    /**
     * Data to pass as 'input-data' to the guest. Usually treated as STDIN to 'command'.
     * @maxLength 65536
     */
    type String0_65536 = string;
    /**
     * The content to write into the file.
     * @maxLength 61440
     */
    type String0_61440 = string;
    /**
     * The RRD consolidation function
     */
    type Tcf = 'AVERAGE' | 'MAX';
    /**
     * Specify the time frame you are interested in.
     */
    type Ttimeframe = 'hour' | 'day' | 'week' | 'month' | 'year';
    /**
     * Fetch config values from given snapshot.
     * @format pve-configid
     * @maxLength 40
     */
    type pveconfigid_3 = string;
    /**
     ...
     * @type integer
     */
    type integer1_30 = number;
    /**
     * opens a serial terminal (defaults to display)
     */
    type Tserial_1 = 'serial0' | 'serial1' | 'serial2' | 'serial3';
    /**
     ...
     */
    type Tmigration_type = 'secure' | 'insecure';
    /**
     * Mapping from source to target storages. Providing only a single storage ID maps all source storages to that storage. Providing the special value '1' will map each source storage to itself.
     * @format storagepair-list
     */
    type storagepairlist = string;
    /**
     * Feature to check.
     */
    type Tfeature = 'snapshot' | 'clone' | 'copy';
    /**
     * Target format for file storage. Only valid for full clone.
     */
    type Tformat = 'raw' | 'qcow2' | 'vmdk';
    /**
     * The disk you want to move.
     */
    type Tdisk = 'ide0' | 'ide1' | 'ide2' | 'ide3' | 'scsi0' | 'scsi1' | 'scsi2' | 'scsi3' | 'scsi4' | 'scsi5' | 'scsi6' | 'scsi7' | 'scsi8' | 'scsi9' | 'scsi10' | 'scsi11' | 'scsi12' | 'scsi13' | 'scsi14' | 'scsi15' | 'scsi16' | 'scsi17' | 'scsi18' | 'scsi19' | 'scsi20' | 'scsi21' | 'scsi22' | 'scsi23' | 'scsi24' | 'scsi25' | 'scsi26' | 'scsi27' | 'scsi28' | 'scsi29' | 'scsi30' | 'virtio0' | 'virtio1' | 'virtio2' | 'virtio3' | 'virtio4' | 'virtio5' | 'virtio6' | 'virtio7' | 'virtio8' | 'virtio9' | 'virtio10' | 'virtio11' | 'virtio12' | 'virtio13' | 'virtio14' | 'virtio15' | 'sata0' | 'sata1' | 'sata2' | 'sata3' | 'sata4' | 'sata5' | 'efidisk0';
    /**
     ...
     * Config type.
     */
    type Ttype_10 = 'user' | 'network' | 'meta';
    /**
     * OS architecture type.
     */
    type Tarch_1 = 'amd64' | 'i386' | 'arm64' | 'armhf';
    /**
     * Console mode. By default, the console command tries to open a connection to one of the available tty devices. By setting cmode to 'console' it tries to attach to /dev/console instead. If you set cmode to 'shell', it simply invokes a shell inside the container (no login).
     */
    type Tcmode = 'shell' | 'console' | 'tty';
    /**
     ...
     */
    type Tfeatures = string;
    /**
     * Set a host name for the container.
     * @format dns-name
     * @maxLength 255
     */
    type dnsname_1 = string;
    /**
     * Lock/unlock the VM.
     */
    type Tlock_1 = 'backup' | 'create' | 'destroyed' | 'disk' | 'fstrim' | 'migrate' | 'mounted' | 'rollback' | 'snapshot' | 'snapshot-delete';
    /**
     ...
     */
    type Tostype_1 = 'debian' | 'ubuntu' | 'centos' | 'fedora' | 'opensuse' | 'archlinux' | 'alpine' | 'gentoo' | 'unmanaged';
    /**
     ...
     * @type integer
     */
    type integer8_32768 = number;
    /**
     * Only list specific types of disks.
     */
    type Ttype_11 = 'unused' | 'journal_disks';
    /**
     ...
     */
    type Tservice_1 = string;
    /**
     * The application of the pool, 'rbd' by default.
     */
    type Tapplication = 'rbd' | 'cephfs' | 'rgw';
    /**
     ...
     */
    type Ttype_12 = 'bridge' | 'bond' | 'eth' | 'alias' | 'vlan' | 'OVSBridge' | 'OVSBond' | 'OVSPort' | 'OVSIntPort' | 'any_bridge';
    /**
     * IP address.
     * @format ipv4
     */
     ...
     * @format pve-iface
     */
    type pveiface_1 = string;
    /**
     * Bonding mode.
     */
    type Tbond_mode = 'balance-rr' | 'active-backup' | 'balance-xor' | 'broadcast' | '802.3ad' | 'balance-tlb' | 'balance-alb' | 'balance-slb' | 'lacp-balance-slb' | 'lacp-balance-tcp';
    /**
     * Selects the transmit hash policy to use for slave selection in balance-xor and 802.3ad modes.
     */
    type Tbond_xmit_hash_policy = 'layer2' | 'layer2+3' | 'layer3+4';
    /**
     * Specify the interfaces you want to add to your bridge.
     * @format pve-iface-list
     */
    type pveifacelist = string;
    /**
     * MTU.
     * @minimum 1280
     * @maximum 65520
     ...
     * @type integer
     */
    type integer0_128 = number;
    /**
     * OVS interface options.
     * @maxLength 1024
     */
    type String0_1024 = string;
    /**
     ...
     * @type integer
     */
    type integer1_4094 = number;
    /**
     * Network interface type
     */
    type Ttype_13 = 'bridge' | 'bond' | 'eth' | 'alias' | 'vlan' | 'OVSBridge' | 'OVSBond' | 'OVSPort' | 'OVSIntPort' | 'unknown';
    /**
     * List archived, active or all tasks.
     */
    type Tsource = 'archive' | 'active' | 'all';
    /**
     * The server address (name or IP).
     * @format pve-storage-server
     */
    type pvestorageserver = string;
    /**
     * The iSCSI portal (IP or DNS name with optional port).
     * @format pve-storage-portal-dns
     */
    type pvestorageportaldns = string;
    /**
     ...
     */
    type pvestoragecontentlist = string;
    /**
     * Only list content of this type.
     * @format pve-storage-content
     */
    type pvestoragecontent = string;
    type Tformat_1 = 'raw' | 'qcow2' | 'subvol';
    /**
     ...
     * @type integer
     */
    type integer9_16 = number;
    /**
     * The compression algorithm to use.
     */
    type Tcompression = 'on' | 'off' | 'gzip' | 'lz4' | 'lzjb' | 'zle';
    /**
     * The RAID level to use.
     */
    type Traidlevel = 'single' | 'mirror' | 'raid10' | 'raidz' | 'raidz2' | 'raidz3';
    /**
     * Block device name
     ...
     * @type integer
     */
    type integer_Min32768 = number;
    /**
     * Conntrack established timeout.
     * @minimum 7875
     * @type integer
     */
    type integer_Min7875 = number;
    /**
     ...
     * @type integer
     */
    type integer30_60 = number;
    /**
     * PEM encoded certificate (chain).
     * @format pem-certificate-chain
     */
    type pemcertificatechain = string;
    /**
     ...
     */
    type Tproperty = 'acme' | 'acmedomain0' | 'acmedomain1' | 'acmedomain2' | 'acmedomain3' | 'acmedomain4' | 'acmedomain5' | 'description' | 'startall-onboot-delay' | 'wakeonlan';
    /**
     ...
     * @type integer
     */
    type integer0_300 = number;
    /**
     * Specify the command.
     */
    type Tcommand_1 = 'reboot' | 'shutdown';
    /**
     ...
     */
    type Tcmd = 'login' | 'ceph_install' | 'upgrade';
    /**
     * Only list storage of specific type
     */
    type Ttype_14 = 'cephfs' | 'cifs' | 'dir' | 'drbd' | 'glusterfs' | 'iscsi' | 'iscsidirect' | 'lvm' | 'lvmthin' | 'nfs' | 'pbs' | 'rbd' | 'zfs' | 'zfspool';
    /**
     * CIFS domain.
     * @maxLength 256
     */
    type String0_256 = string;
    /**
     * NFS export path.
     * @format pve-storage-path
     */
    type pvestoragepath = string;
    /**
     * Default image format.
     * @format pve-storage-format
     */
    type pvestorageformat = string;
    /**
     * IP addresses of monitors (for external clusters).
     * @format pve-storage-portal-dns-list
     */
    type pvestorageportaldnslist = string;
    /**
     * NFS mount options (see 'man nfs')
     * @format pve-storage-options
     */
    type pvestorageoptions = string;
    /**
     ...
     * @type integer
     */
    type integer1_16 = number;
    /**
     * SMB protocol version
     */
    type Tsmbversion = '2.0' | '2.1' | '3.0';
    /**
     * LVM thin pool LV name.
     * @format pve-storage-vgname
     */
    type pvestoragevgname = string;
    /**
     * Gluster transport: tcp or rdma
     */
    type Ttransport = 'tcp' | 'rdma' | 'unix';
    /**
     * @format pve-groupid-list
     */
    type pvegroupidlist = string;
    /**
     * Initial password.
     * @minLength 5
     * @maxLength 64
     */
    type String5_64 = string;
    /**
     * User ID
     * @format pve-userid
     * @maxLength 64
     */
    type pveuserid = string;
    /**
     * @format pve-groupid
     */
    type pvegroupid = string;
    /**
     * @format pve-priv-list
     */
    type pveprivlist = string;
    /**
     * @format pve-roleid
     */
    type pveroleid = string;
    /**
     * List of roles.
     * @format pve-roleid-list
     */
    type pveroleidlist = string;
    /**
     * List of API tokens.
     * @format pve-tokenid-list
     */
    type pvetokenidlist = string;
    /**
     * List of users.
     * @format pve-userid-list
     */
    type pveuseridlist = string;
    /**
     * LDAP base domain name
     * @pattern \w+=[^,]+(,\s*\w+=[^,]+)*
     * @maxLength 256
     */
    type Tbase_dn = string;
    /**
     * AD domain name
     * @pattern \S+
     * @maxLength 256
     ...
     * @maxLength 2048
     */
    type String0_2048 = string;
    /**
     * The objectclasses for groups.
     * @format ldap-simple-attr-list
     */
    type ldapsimpleattrlist = string;
    /**
     ...
     * @maxLength 256
     */
    type ldapsimpleattr = string;
    /**
     * LDAP protocol mode.
     */
    type Tmode_1 = 'ldap' | 'ldaps' | 'ldap+starttls';
    /**
     * Server port.
     * @minimum 1
     * @maximum 65535
     * @type integer
     */
    type integer1_65535 = number;
    /**
     * Authentication domain ID
     * @format pve-realm
     * @maxLength 32
     */
    type pverealm = string;
    /**
     ...
     */
    type Tsslversion = 'tlsv1' | 'tlsv1_1' | 'tlsv1_2' | 'tlsv1_3';
    /**
     * The default options for behavior of synchronizations.
     * @format realm-sync-options
     */
    type realmsyncoptions = string;
    /**
     ...
     * @pattern \w+=[^,]+(,\s*\w+=[^,]+)*
     */
    type Tsync_attributes = string;
    /**
     * Use Two-factor authentication.
     * @format pve-tfa-config
     * @maxLength 128
     */
    type pvetfaconfig = string;
    /**
     * Realm type.
     */
    type Ttype_15 = 'ad' | 'ldap' | 'pam' | 'pve';
    /**
     * LDAP user attribute name
     * @pattern \S{2,}
     * @maxLength 256
     */
    type Tuser_attr = string;
    /**
     * Select what to sync.
     */
    type Tscope_1 = 'users' | 'groups' | 'both';
    /**
     * Verify ticket, and check if user have access 'privs' on 'path'
     * @maxLength 64
     */
    type String0_64 = string;
    /**
     * Verify ticket, and check if user have access 'privs' on 'path'
     * @format pve-priv-list
     * @maxLength 64
     */
    type pveprivlist_1 = string;
    /**
     * The action to perform
     */
    type Taction_1 = 'delete' | 'new' | 'confirm';
    /**
     * When adding TOTP, the shared secret value.
     * @format pve-tfa-secret
     */
    type pvetfasecret = string;
    /**
     ...
     */
    interface clusterReplicationIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface clusterConfigNodesNodes {
        node: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface clusterConfigNodesAddnode {
     ...
     */
    interface clusterConfigJoinJoinInfo {
     ...
     */
    interface clusterFirewallIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface clusterFirewallGroupsListSecurityGroups {
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
         */
     ...
     */
    interface clusterFirewallGroupsGetRules {
        pos: number;
        /**
         * additionalProperties
         */
     ...
     */
    interface clusterFirewallGroupsGetRule {
        action: string;
        comment?: string;
        dest?: string;
        dport?: string;
     ...
     */
    interface clusterFirewallRulesGetRules {
        pos: number;
        /**
         * additionalProperties
         */
     ...
     */
    interface clusterFirewallRulesGetRule {
        action: string;
        comment?: string;
        dest?: string;
        dport?: string;
     ...
     */
    interface clusterFirewallIpsetIpsetIndex {
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
         */
     ...
     */
    interface clusterFirewallIpsetGetIpset {
        cidr: string;
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
     ...
     */
    interface clusterFirewallAliasesGetAliases {
        cidr: string;
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
     ...
     */
    interface clusterFirewallOptionsGetOptions {
        /**
     ...
     */
    interface clusterFirewallMacrosGetMacros {
        /**
     ...
     */
    interface clusterFirewallRefsRefs {
        comment?: string;
        name: string;
        ref: string;
        type: string;
     ...
     */
    interface clusterBackupIncludedVolumesGetVolumeBackupIncluded {
        children: {
            /**
     ...
     */
    interface clusterBackupinfoNotBackedUpGetGuestsNotInBackup {
        /**
         * Name of the guest
         */
        name?: string;
     ...
     */
    interface clusterHaResourcesIndex {
        sid: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface clusterHaGroupsIndex {
        group: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface clusterHaStatusIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface clusterAcmePluginsIndex {
        /**
     ...
     */
    interface clusterAcmeAccountAccountIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface clusterAcmeAccountGetAccount {
        account?: any;
        /**
         * URL of ACME CA directory endpoint.
         */
     ...
     */
    interface clusterAcmeDirectoriesGetDirectories {
        name: string;
        /**
         * URL of ACME CA directory endpoint.
         */
     ...
     */
    interface clusterAcmeChallengeSchemaChallengeschema {
        id: string;
        /**
     ...
     */
    interface clusterCephCephindex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface clusterCephFlagsGetAllFlags {
        /**
         * Flag name.
         */
        name: string;
     ...
     */
    interface clusterSdnVnetsIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface clusterSdnZonesIndex {
        type: string;
        zone: string;
        /**
         * additionalProperties
     ...
     */
    interface clusterSdnControllersIndex {
        controller: string;
        type: string;
        /**
         * additionalProperties
     ...
     */
    interface nodesQemuFirewallIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesQemuFirewallRulesGetRules {
        pos: number;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesQemuFirewallRulesGetRule {
        action: string;
        comment?: string;
        dest?: string;
        dport?: string;
     ...
     */
    interface nodesQemuFirewallAliasesGetAliases {
        cidr: string;
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
     ...
     */
    interface nodesQemuFirewallIpsetIpsetIndex {
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
         */
     ...
     */
    interface nodesQemuFirewallIpsetGetIpset {
        cidr: string;
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
     ...
     */
    interface nodesQemuFirewallOptionsGetOptions {
        /**
         * Enable DHCP.
         */
        dhcp?: boolean;
     ...
     */
    interface nodesQemuFirewallLogLog {
        /**
         * Line number
         */
        n: number;
     ...
     */
    interface nodesQemuFirewallRefsRefs {
        comment?: string;
        name: string;
        type: string;
        /**
     ...
     */
    interface nodesQemuAgentExecExec {
        /**
     ...
     */
    interface nodesQemuAgentFileReadFileRead {
        /**
     ...
     */
    interface nodesQemuRrddataRrddata {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesQemuVncproxyVncproxy {
        cert: string;
        /**
     ...
     */
    interface nodesQemuTermproxyTermproxy {
        port: number;
        ticket: string;
        upid: string;
        user: string;
     ...
     */
    interface nodesQemuVncwebsocketVncwebsocket {
        port: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesQemuSpiceproxySpiceproxy {
        host: string;
        password: string;
        proxy: string;
        'tls-port': number;
     ...
     */
    interface nodesQemuStatusVmcmdidx {
        subdir: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesQemuFeatureVmFeature {
        hasFeature: boolean;
        nodes: string[];
        /**
         * additionalProperties
     ...
     */
    interface nodesQemuSnapshotSnapshotCmdIdx {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesLxcStatusVmcmdidx {
        subdir: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesLxcSnapshotSnapshotCmdIdx {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesLxcFirewallIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesLxcFirewallRulesGetRules {
        pos: number;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesLxcFirewallRulesGetRule {
        action: string;
        comment?: string;
        dest?: string;
        dport?: string;
     ...
     */
    interface nodesLxcFirewallAliasesGetAliases {
        cidr: string;
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
     ...
     */
    interface nodesLxcFirewallIpsetIpsetIndex {
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
         */
     ...
     */
    interface nodesLxcFirewallIpsetGetIpset {
        cidr: string;
        comment?: string;
        /**
         * Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications.
     ...
     */
    interface nodesLxcFirewallLogLog {
        /**
         * Line number
         */
        n: number;
     ...
     */
    interface nodesLxcFirewallRefsRefs {
        comment?: string;
        name: string;
        type: string;
        /**
     ...
     */
    interface nodesLxcRrddataRrddata {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesLxcVncproxyVncproxy {
        cert: string;
        port: number;
        ticket: string;
        upid: string;
     ...
     */
    interface nodesLxcTermproxyTermproxy {
        port: number;
        ticket: string;
        upid: string;
        user: string;
     ...
     */
    interface nodesLxcVncwebsocketVncwebsocket {
        port: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesLxcSpiceproxySpiceproxy {
        host: string;
        password: string;
        proxy: string;
        'tls-port': number;
     ...
     */
    interface nodesLxcFeatureVmFeature {
        hasFeature: boolean;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesCephConfigdbConfigdb {
     ...
     */
    interface nodesCephPoolsLspools {
        bytes_used: number;
        crush_rule: number;
     ...
     */
    interface nodesServicesSrvcmdidx {
        subdir: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesNetworkNetworkConfig {
        method: string;
        type: string;
        /**
         * additionalProperties
     ...
     */
    interface nodesTasksLogReadTaskLog {
        /**
         * Line number
         */
        n: number;
     ...
     */
    interface nodesTasksStatusReadTaskStatus {
        pid: number;
        status: string;
        /**
         * additionalProperties
     ...
     */
    interface nodesScanCifsCifsscan {
        /**
     ...
     */
    interface nodesScanGlusterfsGlusterfsscan {
        /**
         * The volume name.
         */
        volname: string;
     ...
     */
    interface nodesScanIscsiIscsiscan {
        /**
     ...
     */
    interface nodesScanLvmthinLvmthinscan {
        /**
     ...
     */
    interface nodesHardwarePciPciindex {
        method: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesHardwarePciMdevMdevscan {
        /**
     ...
     */
    interface nodesStorageRrddataRrddata {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesDisksLvmthinIndex {
        /**
     ...
     */
    interface nodesDisksSmartSmart {
        attributes?: string[];
        health: string;
        text?: string;
        type?: string;
     ...
     */
    interface nodesAptUpdateListUpdates {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesAptVersionsVersions {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesFirewallRulesGetRules {
        pos: number;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesFirewallRulesGetRule {
        action: string;
        comment?: string;
        dest?: string;
        dport?: string;
     ...
     */
    interface nodesReplicationStatus {
        id: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesReplicationIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesReplicationLogReadJobLog {
        /**
         * Line number
         */
        n: number;
     ...
     */
    interface nodesCertificatesIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesCertificatesAcmeIndex {
        /**
         * additionalProperties
         */
        [additionalProperties: string]: any;
     ...
     */
    interface nodesCertificatesInfoInfo {
        filename?: string;
        /**
         * Certificate SHA 256 fingerprint.
         */
     ...
     */
    interface nodesCertificatesCustomUploadCustomCert {
        filename?: string;
        /**
         * Certificate SHA 256 fingerprint.
         */
     ...
     */
    interface nodesSdnZonesContentIndex {
        /**
         * Status.
         */
        status?: string;
     ...
     */
    interface nodesVncshellVncshell {
        cert: string;
        port: number;
        ticket: string;
        upid: string;
     ...
     */
    interface nodesTermproxyTermproxy {
        port: number;
        ticket: string;
        upid: string;
        user: string;
     ...
     */
    interface nodesVncwebsocketVncwebsocket {
        port: string;
        /**
         * additionalProperties
         */
     ...
     */
    interface nodesSpiceshellSpiceshell {
        host: string;
        password: string;
        proxy: string;
        'tls-port': number;
     ...
     */
    interface nodesHostsGetEtcHosts {
        /**
     ...
     */
    interface accessUsersTokenTokenIndex {
        comment?: string;
        /**
         * API token expiration date (seconds since epoch). '0' means no expiration date.
         */
     ...
     */
    interface accessGroupsReadGroup {
        comment?: string;
        members: string[];
        /**
         * additionalProperties
     ...
     */
    interface accessTicketCreateTicket {
    ...
    interface Api {
        cluster: {
            ...
            replication: {
                 ...
                 */
                $post(param: {
                    comment?: String0_4096;
                    disable?: boolean;
                    id: pvereplicationjobid;
                    rate?: Trate;
                    remove_job?: Tremove_job;
                    schedule?: pvecalendarevent;
                    source?: pvenode;
                    target: pvenode;
                    type: Ttype;
                }): Promise<null>;
                ...
                nodes: {
                    ...
                    $(node: string): {
                        ...
                        $post(param?: {
                            ...
                            nodeid?: integer_Min1;
                            votes?: integer_Min0;
                        }): Promise<clusterConfigNodesAddnode>;
                    };
                };
                join: {
                    /**
                    ...
                    $get(param?: {
                        node?: pvenode;
                    }): Promise<clusterConfigJoinJoinInfo>;
                    /**
            ...
            firewall: {
                ...
                groups: {
                    ...
                    $(group: string): {
                        ...
                        $post(param: {
                            ...
                            dest?: pvefwaddrspec;
                            digest?: String0_40;
                            dport?: pvefwdportspec;
                            enable?: integer_Min0;
                            iface?: pveiface;
                            log?: Tlog;
                            macro?: String0_128;
                            pos?: integer_Min0;
                            proto?: pvefwprotocolspec;
                            source?: pvefwaddrspec;
                            sport?: pvefwsportspec;
                            type: Ttype_1;
                        }): Promise<null>;
                        $(pos: string): {
                            /**
                ...
                options: {
                    ...
                    $put(param?: {
                        ...
                        ebtables?: boolean;
                        enable?: integer_Min0;
                        log_ratelimit?: Tlog_ratelimit;
                        policy_in?: Tpolicy_in;
                        policy_out?: Tpolicy_in;
                    }): Promise<null>;
                };
                macros: {
                    /**
                ...
                refs: {
                    ...
                    $get(param?: {
                        type?: Ttype_2;
                    }): Promise<clusterFirewallRefsRefs[]>;
                };
            };
            backup: {
                /**
                ...
                $post(param: {
                    all?: boolean;
                    bwlimit?: integer_Min0;
                    compress?: Tcompress;
                    dow?: pvedayofweeklist;
                    dumpdir?: string;
                    enabled?: boolean;
                    exclude?: pvevmidlist;
                    'exclude-path'?: stringalist;
                    ionice?: integer0_8;
                    lockwait?: integer_Min0;
                    mailnotification?: Tmailnotification;
                    mailto?: stringlist;
                    maxfiles?: integer_Min1;
                    mode?: Tmode;
                    node?: pvenode;
                    pigz?: integer;
                    pool?: string;
                    ...
                    stdexcludes?: boolean;
                    stop?: boolean;
                    stopwait?: integer_Min0;
                    storage?: pvestorageid;
                    tmpdir?: string;
                    vmid?: pvevmidlist;
                    zstd?: integer;
                }): Promise<null>;
            ...
            ha: {
                ...
                resources: {
                    ...
                    $get(param?: {
                        type?: Ttype_3;
                    }): Promise<clusterHaResourcesIndex[]>;
                    /**
                    ...
                    $post(param: {
                        comment?: String0_4096;
                        group?: pveconfigid;
                        max_relocate?: integer_Min0;
                        max_restart?: integer_Min0;
                        sid: pveharesourceorvmid;
                        state?: Tstate;
                        type?: Ttype_3;
                    }): Promise<null>;
                    $(sid: string): {
            ...
            acme: {
                ...
                plugins: {
                    ...
                    $get(param?: {
                        type?: Ttype_5;
                    }): Promise<clusterAcmePluginsIndex[]>;
                    /**
                    ...
                    $post(param: {
                        ...
                        nodes?: pvenodelist;
                        type: Ttype_5;
                        'validation-delay'?: integer0_172800;
                    }): Promise<null>;
                    $(id: string): {
                        /**
            ...
            sdn: {
                ...
                controllers: {
                    ...
                    $get(param?: {
                        type?: Ttype_8;
                    }): Promise<clusterSdnControllersIndex[]>;
                    /**
                    ...
                    $post(param: {
                        asn?: integer;
                        controller: pvesdncontrollerid;
                        'gateway-external-peers'?: iplist;
                        'gateway-nodes'?: pvenodelist;
                        peers?: iplist;
                        type: pveconfigid_2;
                    }): Promise<null>;
                    $(controller: string): {
            ...
            resources: {
                ...
                $get(param?: {
                    type?: Ttype_9;
                }): Promise<clusterResourcesResources[]>;
            };
            tasks: {
                /**
            ...
            options: {
                ...
                $put(param?: {
                    ...
                    fencing?: Tfencing;
                    ha?: Tha;
                    http_proxy?: Thttp_proxy;
                    keyboard?: Tkeyboard;
                    language?: Tlanguage;
                    mac_prefix?: macprefix;
                    max_workers?: integer_Min1;
            ...
            $(node: string): {
                ...
                qemu: {
                    ...
                    $post(param: {
                        ...
                        audio0?: Taudio0;
                        autostart?: boolean;
                        balloon?: integer_Min0;
                        bios?: Tbios;
                        boot?: Tboot;
                        bootdisk?: pveqmbootdisk;
                        bwlimit?: integer_Min0;
                        cdrom?: pveqmide;
                        cicustom?: pveqmcicustom;
                        cipassword?: string;
                        citype?: Tcitype;
                        ciuser?: string;
                        cores?: integer_Min1;
                        ...
                        hotplug?: pvehotplugfeatures;
                        hugepages?: Thugepages;
                        ide0?: Tide;
                        ide1?: Tide;
                        ide2?: Tide;
                        ide3?: Tide;
                        ...
                        lock?: Tlock;
                        machine?: Tmachine;
                        memory?: integer_Min16;
                        migrate_downtime?: Tmigrate_downtime;
                        migrate_speed?: integer_Min0;
                        name?: dnsname;
                        ...
                        serial2?: Tserial;
                        serial3?: Tserial;
                        shares?: integer0_50000;
                        smbios1?: pveqmsmbios1;
                        smp?: integer_Min1;
                        sockets?: integer_Min1;
                        spice_enhancements?: Tspice_enhancements;
                        sshkeys?: urlencoded;
                        start?: boolean;
                        startdate?: Tstartdate;
                        startup?: pvestartuporder;
                        storage?: pvestorageid;
                        tablet?: boolean;
                        tags?: pvetaglist;
                        tdf?: boolean;
                        ...
                        vmgenid?: Tvmgenid;
                        vmid: pvevmid;
                        vmstatestorage?: pvestorageid;
                        watchdog?: pveqmwatchdog;
                    }): Promise<string>;
                    $(vmid: number): {
                        /**
                        ...
                        firewall: {
                            ...
                            log: {
                                ...
                                $get(param?: {
                                    limit?: integer_Min0;
                                    start?: integer_Min0;
                                }): Promise<nodesQemuFirewallLogLog[]>;
                            };
                            refs: {
                                /**
                                 * Lists possible IPSet/Alias reference which are allowed in source/dest properties.
                                ...
                                $get(param?: {
                                    type?: Ttype_2;
                                }): Promise<nodesQemuFirewallRefsRefs[]>;
                            };
                        };
                        agent: {
                            /**
                            ...
                            exec: {
                                ...
                                $post(param?: {
                                    command?: stringalist;
                                    'input-data'?: String0_65536;
                                }): Promise<nodesQemuAgentExecExec>;
                            };
                            'exec-status': {
                                /**
                                ...
                                $get(param: {
                                    pid: integer;
                                }): Promise<nodesQemuAgentExecStatusExecStatus>;
                            };
                            'file-read': {
                                /**
                                ...
                                $get(param: {
                                    file: string;
                                }): Promise<nodesQemuAgentFileReadFileRead>;
                            };
                            'file-write': {
                                /**
                        ...
                        rrd: {
                            ...
                            $get(param: {
                                cf?: Tcf;
                                ds: pveconfigidlist_1;
                                timeframe: Ttimeframe;
                            }): Promise<nodesQemuRrdRrd>;
                        };
                        rrddata: {
                            /**
                            ...
                            $get(param: {
                                cf?: Tcf;
                                timeframe: Ttimeframe;
                            }): Promise<nodesQemuRrddataRrddata[]>;
                        };
                        config: {
                            /**
                            ...
                            $get(param?: {
                                current?: boolean;
                                snapshot?: pveconfigid_3;
                            }): Promise<nodesQemuConfigVmConfig>;
                            /**
                        ...
                        vncproxy: {
                            ...
                            $post(param?: {
                                ...
                                websocket?: boolean;
                            }): Promise<nodesQemuVncproxyVncproxy>;
                        };
                        termproxy: {
                            /**
                        ...
                        vncwebsocket: {
                             ...
                             */
                            $get(param: {
                                port: integer5900_5999;
                                vncticket: String0_512;
                            }): Promise<nodesQemuVncwebsocketVncwebsocket>;
                        };
                        spiceproxy: {
                            /**
                            ...
                            $post(param?: {
                                proxy?: address;
                            }): Promise<nodesQemuSpiceproxySpiceproxy>;
                        };
                        status: {
                            /**
                             * Directory index
                            ...
                            start: {
                                ...
                                $post(param?: {
                                    'force-cpu'?: string;
                                    machine?: Tmachine;
                                    migratedfrom?: pvenode;
                                    migration_network?: CIDR;
                                    migration_type?: Tmigration_type;
                                    skiplock?: boolean;
                                    stateuri?: String0_128;
                                    targetstorage?: storagepairlist;
                                    timeout?: integer_Min0;
                                }): Promise<string>;
                            };
                            stop: {
                                /**
                        ...
                        feature: {
                            ...
                            $get(param: {
                                feature: Tfeature;
                                snapname?: pveconfigid_3;
                            }): Promise<nodesQemuFeatureVmFeature>;
                        };
                        clone: {
                            /**
                        ...
                        migrate: {
                            ...
                            $get(param?: {
                                target?: pvenode;
                            }): Promise<nodesQemuMigrateMigrateVmPrecondition>;
                            /**
                ...
                lxc: {
                    ...
                    $post(param: {
                        arch?: Tarch_1;
                        bwlimit?: Tmigrate_downtime;
                        cmode?: Tcmode;
                        console?: boolean;
                        cores?: integer1_128;
                        cpulimit?: Tcpulimit;
                        cpuunits?: integer0_500000;
                        description?: string;
                        features?: Tfeatures;
                        force?: boolean;
                        hookscript?: pvevolumeid;
                    ...
                    $(vmid: number): {
                        ...
                        config: {
                            ...
                            $get(param?: {
                                current?: boolean;
                                snapshot?: pveconfigid_3;
                            }): Promise<nodesLxcConfigVmConfig>;
                            /**
                        ...
                        firewall: {
                            ...
                            log: {
                                ...
                                $get(param?: {
                                    limit?: integer_Min0;
                                    start?: integer_Min0;
                                }): Promise<nodesLxcFirewallLogLog[]>;
                            };
                            refs: {
                                /**
                                 * Lists possible IPSet/Alias reference which are allowed in source/dest properties.
                                ...
                                $get(param?: {
                                    type?: Ttype_2;
                                }): Promise<nodesLxcFirewallRefsRefs[]>;
                            };
                        };
                        rrd: {
                            /**
                        ...
                        rrddata: {
                            ...
                            $get(param: {
                                cf?: Tcf;
                                timeframe: Ttimeframe;
                            }): Promise<nodesLxcRrddataRrddata[]>;
                        };
                        vncproxy: {
                            /**
                             * Creates a TCP VNC proxy connections.
                             ...
                             */
                            $post(param?: {
                                height?: integer16_2160;
                                websocket?: boolean;
                                width?: integer16_4096;
                            }): Promise<nodesLxcVncproxyVncproxy>;
                        };
                        termproxy: {
                            /**
                        ...
                        vncwebsocket: {
                            ...
                            $get(param: {
                                port: integer5900_5999;
                                vncticket: String0_512;
                            }): Promise<nodesLxcVncwebsocketVncwebsocket>;
                        };
                        spiceproxy: {
                            /**
                            ...
                            $post(param?: {
                                proxy?: address;
                            }): Promise<nodesLxcSpiceproxySpiceproxy>;
                        };
                        migrate: {
                            /**
                        ...
                        feature: {
                            ...
                            $get(param: {
                                feature: Tfeature;
                                snapname?: pveconfigid_3;
                            }): Promise<nodesLxcFeatureVmFeature>;
                        };
                        template: {
                            /**
                             * Create a Template.
                ...
                network: {
                    ...
                    $post(param: {
                        ...
                        address6?: ipv6;
                        autostart?: boolean;
                        'bond-primary'?: pveiface_1;
                        bond_mode?: Tbond_mode;
                        bond_xmit_hash_policy?: Tbond_xmit_hash_policy;
                        bridge_ports?: pveifacelist;
                        ...
                        gateway6?: ipv6;
                        iface: pveiface;
                        mtu?: integer1280_65520;
                        netmask?: ipv4mask;
                        netmask6?: integer0_128;
                        ovs_bonds?: pveifacelist;
                        ovs_bridge?: pveiface_1;
                        ovs_options?: String0_1024;
                        ovs_ports?: pveifacelist;
                        ovs_tag?: integer1_4094;
                        slaves?: pveifacelist;
                        type: Ttype_13;
                        'vlan-id'?: integer1_4094;
                        'vlan-raw-device'?: pveiface_1;
                    }): Promise<null>;
                    /**
                    ...
                    $(upid: string): {
                        ...
                        log: {
                            ...
                            $get(param?: {
                                limit?: integer_Min0;
                                start?: integer_Min0;
                            }): Promise<nodesTasksLogReadTaskLog[]>;
                        };
                        status: {
                            /**
                             * Read task status.
                ...
                scan: {
                    ...
                    nfs: {
                         ...
                         */
                        $get(param: {
                            server: pvestorageserver;
                        }): Promise<nodesScanNfsNfsscan[]>;
                    };
                    cifs: {
                        /**
                    ...
                    glusterfs: {
                        ...
                        $get(param: {
                            server: pvestorageserver;
                        }): Promise<nodesScanGlusterfsGlusterfsscan[]>;
                    };
                    iscsi: {
                        /**
                         ...
                         */
                        $get(param: {
                            portal: pvestorageportaldns;
                        }): Promise<nodesScanIscsiIscsiscan[]>;
                    };
                    lvm: {
                        /**
                    ...
                    lvmthin: {
                        ...
                        $get(param: {
                            vg: Tvg;
                        }): Promise<nodesScanLvmthinLvmthinscan[]>;
                    };
                    usb: {
                        /**
                ...
                hardware: {
                    ...
                    pci: {
                         ...
                         */
                        $get(param?: {
                            'pci-class-blacklist'?: stringlist;
                            verbose?: boolean;
                        }): Promise<nodesHardwarePciPciscan[]>;
                        $(pciid: string): {
                            /**
                ...
                storage: {
                     ...
                     */
                    $get(param?: {
                        content?: pvestoragecontentlist;
                        enabled?: boolean;
                        format?: boolean;
                        storage?: pvestorageid;
                        target?: pvenode;
                    }): Promise<nodesStorageIndex[]>;
                    $(storage: string): {
                        /**
                         *
                         * @allowtoken 1
                        ...
                        content: {
                             ...
                             */
                            $get(param?: {
                                content?: pvestoragecontent;
                                vmid?: pvevmid;
                            }): Promise<nodesStorageContentIndex[]>;
                            /**
                        ...
                        rrddata: {
                            ...
                            $get(param: {
                                cf?: Tcf;
                                timeframe: Ttimeframe;
                            }): Promise<nodesStorageRrddataRrddata[]>;
                        };
                        upload: {
                            /**
                ...
                firewall: {
                    ...
                    options: {
                        ...
                        $put(param?: {
                            ...
                            ndp?: boolean;
                            nf_conntrack_allow_invalid?: boolean;
                            nf_conntrack_max?: integer_Min32768;
                            nf_conntrack_tcp_timeout_established?: integer_Min7875;
                            nf_conntrack_tcp_timeout_syn_recv?: integer30_60;
                            nosmurfs?: boolean;
                            protection_synflood?: boolean;
                            protection_synflood_burst?: integer;
                            protection_synflood_rate?: integer;
                            smurf_log_level?: Tlog;
                            tcp_flags_log_level?: Tlog;
                            tcpflags?: boolean;
                        }): Promise<null>;
                    };
                    log: {
                ...
                replication: {
                    ...
                    $get(param?: {
                        guest?: pvevmid;
                    }): Promise<nodesReplicationStatus[]>;
                    $(id: string): {
                        /**
                         * Directory index.
                        ...
                        log: {
                            ...
                            $get(param?: {
                                limit?: integer_Min0;
                                start?: integer_Min0;
                            }): Promise<nodesReplicationLogReadJobLog[]>;
                        };
                        schedule_now: {
                            /**
                ...
                certificates: {
                    ...
                    custom: {
                         ...
                         */
                        $post(param: {
                            certificates: pemcertificatechain;
                            force?: boolean;
                            key?: pemstring;
                            restart?: boolean;
                        }): Promise<nodesCertificatesCustomUploadCustomCert>;
                    };
                };
                config: {
                    /**
                    ...
                    $put(param?: {
                        acme?: Tacme;
                        acmedomain0?: Tacmedomain;
                        acmedomain1?: Tacmedomain;
                        acmedomain2?: Tacmedomain;
                        acmedomain3?: Tacmedomain;
                        delete?: pveconfigidlist_1;
                        description?: string;
                        digest?: String0_40;
                        'startall-onboot-delay'?: integer0_300;
                        wakeonlan?: macaddr;
                    }): Promise<null>;
                };
                sdn: {
                ...
                termproxy: {
                    ...
                    $post(param?: {
                        cmd?: Tcmd;
                        upgrade?: boolean;
                    }): Promise<nodesTermproxyTermproxy>;
                };
                vncwebsocket: {
                    /**
                     * Opens a weksocket for VNC traffic.
                    ...
                    $get(param: {
                        port: integer5900_5999;
                        vncticket: String0_512;
                    }): Promise<nodesVncwebsocketVncwebsocket>;
                };
                spiceshell: {
                    /**
                    ...
                    $post(param?: {
                        ...
                        proxy?: address;
                        upgrade?: boolean;
                    }): Promise<nodesSpiceshellSpiceshell>;
                };
                dns: {
                    /**
                     * Read DNS settings.
        ...
        storage: {
            ...
            $post(param: {
                ...
                export?: pvestoragepath;
                fingerprint?: Tfingerprint;
                format?: pvestorageformat;
                fuse?: boolean;
                is_mountpoint?: string;
                iscsiprovider?: string;
                krbd?: boolean;
                lio_tpg?: string;
                maxfiles?: integer_Min0;
                mkdir?: boolean;
                monhost?: pvestorageportaldnslist;
                mountpoint?: pvestoragepath;
                nodes?: pvenodelist;
                nowritecache?: boolean;
                options?: pvestorageoptions;
                password?: String0_256;
                path?: pvestoragepath;
                pool?: string;
                portal?: pvestorageportaldns;
                redundancy?: integer1_16;
                saferemove?: boolean;
                saferemove_throughput?: string;
                server?: pvestorageserver;
                server2?: pvestorageserver;
                share?: string;
                shared?: boolean;
                smbversion?: Tsmbversion;
                sparse?: boolean;
                storage: pvestorageid;
                subdir?: pvestoragepath;
                tagged_only?: boolean;
                target?: string;
                thinpool?: pvestoragevgname;
                transport?: Ttransport;
                type: Ttype_14;
                username?: string;
                vgname?: pvestoragevgname;
                volume?: string;
            }): Promise<null>;
            $(storage: string): {
                /**
        ...
        access: {
                    ...
                    token: {
                        ...
                        $(tokenid: string): {
                            ...
                            $post(param?: {
                                ...
                                expire?: integer_Min0;
                                privsep?: boolean;
                            }): Promise<accessUsersTokenGenerateToken>;
                            /**
                            ...
                            $put(param?: {
                                ...
                                expire?: integer_Min0;
                                privsep?: boolean;
                            }): Promise<accessUsersTokenUpdateTokenInfo>;
                        };
                    };
                };
            };
            ...
            domains: {
                ...
                $post(param: {
                    ...
                    domain?: Tdomain;
                    filter?: String0_2048;
                    group_classes?: ldapsimpleattrlist;
                    group_dn?: Tbase_dn;
                    group_filter?: String0_2048;
                    group_name_attr?: ldapsimpleattr;
                    mode?: Tmode_1;
                    password?: string;
                    port?: integer1_65535;
                    realm: pverealm;
                    ...
                    'sync-defaults-options'?: realmsyncoptions;
                    sync_attributes?: Tsync_attributes;
                    tfa?: pvetfaconfig;
                    type: Ttype_15;
                    user_attr?: Tuser_attr;
                    user_classes?: ldapsimpleattrlist;
                    verify?: boolean;
                }): Promise<null>;
                $(realm: string): {
                    /**
            ...
            ticket: {
                ...
                $post(param: {
                    ...
                    realm?: pverealm;
                    username: String0_64;
                }): Promise<accessTicketCreateTicket>;
            };
            password: {
                /**
